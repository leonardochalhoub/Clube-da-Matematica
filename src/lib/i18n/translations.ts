...
export const TRANSLATIONS: Record<string, Translations> = {
  ...
  'audio.read': {
    ...
    vi: 'Nghe', pl: 'Słuchaj', sw: 'Sikia', ar: 'استمع', he: 'הקשב', hi: 'सुनें', et: 'Kuula',
  },
  'audio.stop': {
    'pt-BR': 'Parar', en: 'Stop', es: 'Detener', zh: '停', ja: '停止',
    de: 'Stopp', fr: 'Arrêter', it: 'Ferma', ru: 'Стоп', ko: '정지',
    vi: 'Dừng', pl: 'Stop', sw: 'Simama', ar: 'إيقاف', he: 'עצור', hi: 'रोकें', et: 'Peata',
  },
  'audio.translating': {
    ...
    sw: 'Inatafsiri…', ar: 'يترجم…', he: 'מתרגם…', hi: 'अनुवाद हो रहा है…', et: 'Tõlgin…',
  },
  ...
  'locale.label': {
    ...
    vi: 'Ngôn ngữ', pl: 'Język', sw: 'Lugha', ar: 'اللغة', he: 'שפה', hi: 'भाषा', et: 'Keel',
  },
  ...
  'counters.visits': {
    ...
    vi: 'lượt truy cập', pl: 'odwiedzin', sw: 'ziara', ar: 'زيارات', he: 'ביקורים', hi: 'विज़िट', et: 'külastust',
  },
  'counters.lessons.published': {
    ...
    sw: 'masomo yaliyochapishwa', ar: 'دروس منشورة', he: 'שיעורים שפורסמו', hi: 'प्रकाशित पाठ', et: 'avaldatud õppetundi',
  },
  'counters.exercises': {
    'pt-BR': 'exercícios', en: 'exercises', es: 'ejercicios', zh: '练习', ja: '演習',
    de: 'Übungen', fr: 'exercices', it: 'esercizi', ru: 'упражнений', ko: '연습',
    vi: 'bài tập', pl: 'ćwiczeń', sw: 'mazoezi', ar: 'تمارين', he: 'תרגילים', hi: 'अभ्यास', et: 'harjutust',
  },
  'counters.exam.versions': {
    ...
    sw: 'matoleo ya mtihani', ar: 'إصدارات الامتحان', he: 'גרסאות מבחן', hi: 'परीक्षा संस्करण', et: 'eksami versiooni',
  },
  'counters.study.total': {
    ...
    sw: 'jumla ya masomo', ar: 'إجمالي الدراسة', he: 'סך הלימוד', hi: 'कुल अध्ययन', et: 'õppimist kokku',
  },
  'counters.books.ledger': {
    ...
    sw: 'vitabu kwenye orodha', ar: 'كتب في السجل', he: 'ספרים בקטלוג', hi: 'सूची में पुस्तकें', et: 'raamatut registris',
  },
  ...
  'search.eyebrow': {
    ...
    vi: 'Khám phá', pl: 'Odkryj', sw: 'Gundua', ar: 'اكتشف', he: 'גלה', hi: 'खोजें', et: 'Avasta',
  },
  'search.title': {
  ...
  'search.lessons.label': {
    ...
    vi: 'Bài học', pl: 'Lekcje', sw: 'Masomo', ar: 'دروس', he: 'שיעורים', hi: 'पाठ', et: 'Õppetunnid',
  },
  'search.books.label': {
    'pt-BR': 'Livros', en: 'Books', es: 'Libros', zh: '书籍', ja: '書籍',
    de: 'Bücher', fr: 'Livres', it: 'Libri', ru: 'Книги', ko: '도서',
  ...
  'footer.authorship': {
    ...
    vi: 'Tác giả', pl: 'Autorzy', sw: 'Waandishi', ar: 'المؤلفون', he: 'מחברים', hi: 'लेखक', et: 'Autorid',
  },
  'footer.navigation': {
    ...
    vi: 'Điều hướng', pl: 'Nawigacja', sw: 'Urambazaji', ar: 'تصفح', he: 'ניווט', hi: 'नेविगेशन', et: 'Navigeerimine',
  },
  'footer.allContent': {
    ...
    sw: 'Yaliyomo yote', ar: 'كل المحتوى', he: 'כל התוכן', hi: 'सभी सामग्री', et: 'Kogu sisu',
  },
  'footer.openSource': {
    ...
    vi: 'Mã nguồn mở', pl: 'Open source', sw: 'Chanzo huru', ar: 'مفتوح المصدر', he: 'קוד פתוח', hi: 'ओपन सोर्स', et: 'Avatud lähtekood',
  },
  'footer.repo': {
    ...
    sw: 'Hifadhi ya GitHub', ar: 'مستودع GitHub', he: 'מאגר GitHub', hi: 'GitHub रिपॉजिटरी', et: 'GitHubi repositoorium',
  },
  'footer.license': {
    ...
    sw: 'Leseni ya MIT', ar: 'رخصة MIT', he: 'רישיון MIT', hi: 'MIT लाइसेंस', et: 'MIT litsents',
  },
  ...
  'footer.builtWith': {
    ...
    he: 'נבנה עם', hi: 'से बनाया गया', et: 'ehitatud',
  },
  'footer.khan': {
  ...
  'common.search': {
    ...
    vi: 'Tìm kiếm', pl: 'Szukaj', sw: 'Tafuta', ar: 'بحث', he: 'חפש', hi: 'खोजें', et: 'Otsi',
  },
