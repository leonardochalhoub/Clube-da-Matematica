...
export const PROGRAMA_EM: Ano[] = [
  {
    ...
    trimestres: [
      ...
      },
      {
        ...
        aulas: [
          { num: 11, titulo: 'Razões trigonométricas no triângulo retângulo', topicos: 'sen, cos, tan, aplicações em medição', materia: 'trigonometria' },
          { num: 12, titulo: 'Círculo trigonométrico', topicos: 'Radianos, identidades fundamentais', materia: 'trigonometria' },
          { num: 13, titulo: 'Funções trigonométricas', topicos: 'Periodicidade, gráficos de sin x, cos x, tan x', materia: 'trigonometria' },
          { num: 14, titulo: 'Equações e inequações trigonométricas', topicos: 'sin x = 1/2, etc.', materia: 'trigonometria' },
          { num: 15, titulo: 'Lei dos senos e cossenos', topicos: 'Triângulos não-retângulos, área via 1/2 ab sin C', materia: 'trigonometria' },
          { num: 16, titulo: 'Sequências numéricas', topicos: '(aₙ), recorrência, monotonia, limitação', materia: 'sequencias' },
          { num: 17, titulo: 'Progressões aritméticas (PA)', topicos: 'aₙ = a₁ + (n−1)r, soma de termos', materia: 'sequencias' },
          { num: 18, titulo: 'Progressões geométricas (PG)', topicos: 'aₙ = a₁q^(n−1), soma finita e infinita', materia: 'sequencias' },
          { num: 19, titulo: 'LIMITE INTUITIVO DE SEQUÊNCIA', topicos: '"Para onde vai 1/n?" — ponte explícita pra Trim 5', materia: 'sequencias' },
          { num: 20, titulo: 'Consolidação Trim 2', topicos: 'Problemas integrados', materia: 'sequencias' },
        ],
      },
      {
        num: 3,
        ...
        aulas: [
          { num: 21, titulo: 'Plano cartesiano: distância, ponto médio', topicos: 'd(P,Q), divisão de segmento', materia: 'geometria-analitica' },
          { num: 22, titulo: 'Equação da reta', topicos: 'Forma geral, reduzida, paramétrica', materia: 'geometria-analitica' },
          { num: 23, titulo: 'Posição relativa de retas', topicos: 'Paralelismo, perpendicularidade, ângulo', materia: 'geometria-analitica' },
          { num: 24, titulo: 'Equação da circunferência', topicos: '(x−a)² + (y−b)² = r²', materia: 'geometria-analitica' },
          { num: 25, titulo: 'Cônicas: elipse, parábola, hipérbole', topicos: 'Definições por foco-diretriz e equações', materia: 'geometria-analitica' },
          { num: 26, titulo: 'Vetores no plano', topicos: 'Representação, soma, produto por escalar', materia: 'vetores' },
          { num: 27, titulo: 'Produto escalar', topicos: 'u·v, ângulo entre vetores, projeção', materia: 'vetores' },
          { num: 28, titulo: 'Aplicações de vetores em física', topicos: 'Forças, deslocamento, decomposição', materia: 'vetores' },
          { num: 29, titulo: 'Sistemas lineares 2x2 e 3x3', topicos: 'Substituição, escalonamento básico', materia: 'vetores' },
          { num: 30, titulo: 'Consolidação Trim 3', topicos: 'Síntese geométrica + analítica', materia: 'vetores' },
        ],
      },
      {
        num: 4,
