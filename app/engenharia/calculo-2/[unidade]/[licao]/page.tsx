/**
 * Rota estática para lições de Cálculo 2: /engenharia/calculo-2/[unidade]/[licao]
...
export default async function LicaoPage({ params }: Props) {
  ...
  const loader = manifestoEngCal2[completo]?.['pt-BR']
  if (!loader) notFound()
