/**
 * Rota estática para lições de Cálculo 1: /engenharia/calculo-1/[unidade]/[licao]
 *
 * Por que essa rota existe em vez de usar [disciplina]/[unidade]/[licao]?
 * O segmento estático "calculo-1" tem precedência sobre segmentos dinâmicos
 * no Next.js App Router. Ao isolar o manifesto aqui (~40 MDX files), o
 * webpack só compila esses 40 arquivos por disciplina — em vez dos 294 do
 * manifesto completo, que causava OOM (heap de 12GB) em modo dev.
 */

import { notFound } from 'next/navigation'
import type { Metadata } from 'next'
import { carregarPorSlug, publicadosApenas } from '@/lib/content/loader'
import { manifestoEngCal1 } from '@/lib/content/manifests/manifest-engenharia-calculo-1'
import { LessonPageShell } from '@/components/layout/LessonPageShell'
import { PROGRAMA_ENG } from '@/content/programa-engenharia'

const DISCIPLINA = 'calculo-1'
...
export default async function LicaoPage({ params }: Props) {
  ...
  const loader = manifestoEngCal1[completo]?.['pt-BR']
  if (!loader) notFound()
