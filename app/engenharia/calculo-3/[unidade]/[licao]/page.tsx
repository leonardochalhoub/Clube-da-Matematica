/**
 * Rota estática para lições de Cálculo 3: /engenharia/calculo-3/[unidade]/[licao]
...
export default async function LicaoPage({ params }: Props) {
  ...
  const loader = manifestoEngCal3[completo]?.['pt-BR']
  if (!loader) notFound()
