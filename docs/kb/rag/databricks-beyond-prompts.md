...
> **Source:** Databricks Learning, *Beyond Prompts – Retrieval Agents and Context Engineering* (© 2026 Databricks, Inc.).
> **Purpose:** Official reference for the project's RAG / retrieval-agent architecture. Use as ground truth when designing or reviewing retrieval pipelines, agent prompts, context windows, and token budgets.
> **Status:** Verbatim transcription with light formatting; do not edit prose without re-checking against the original Databricks course.
> **Added to project KB:** 2026-05-04.
...
- **Ambiguity:** Without private context, models default to generic interpretations.
  - *Example Prompt:* "Explain how to secure a lakehouse." (Triggers advice on physical home security rather than Databricks Data Lakehouse governance.)
...
© 2026 Databricks, Inc. All rights reserved. Apache, Apache Spark, Spark, the Spark Logo, Apache Iceberg, Iceberg, and the Apache Iceberg logo are trademarks of the Apache Software Foundation. Reproduced inside this project's KB for internal architectural reference; not republished externally.
